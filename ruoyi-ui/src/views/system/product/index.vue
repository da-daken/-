<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="提供该服务的家政员id" prop="userId">
        <el-input
          v-model="queryParams.userId"
          placeholder="请输入提供该服务的家政员id"
          clearable
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="提供该服务的家政员id" prop="userId">
          <el-input v-model="form.userId" placeholder="请输入提供该服务的家政员id" />
        </el-form-item>
        <el-form-item label="服务类型id" prop="typeId">
        ...
        <el-form-item label="该家政员在此服务的得分" prop="score">
          <el-input v-model="form.score" placeholder="请输入该家政员在此服务的得分" />
        </el-form-item>
        <el-form-item label="是否被删除" prop="isDeleted">
          <el-input v-model="form.isDeleted" placeholder="请输入是否被删除" />
        </el-form-item>
      </el-form>
