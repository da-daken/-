  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="展示大图" prop="img">
          <el-input v-model="form.img" placeholder="请输入展示大图" />
        </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        name: [
          { required: true, message: "服务类型名称不能为空", trigger: "blur" }
        ],
        img: [
          { required: true, message: "展示大图不能为空", trigger: "blur" }
        ],
        content: [
